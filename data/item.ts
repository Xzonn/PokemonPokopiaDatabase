...
export const ItemDataById = Object.fromEntries(ItemData.map((h) => [h.id, h]));
export const ItemDataByHash = Object.fromEntries(ItemData.map((h) => [h.hash, h]));
